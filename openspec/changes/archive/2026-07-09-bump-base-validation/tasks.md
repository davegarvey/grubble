...
- [x] 5.1 After merge, confirm the v5.0.1 release is published with correct assets.
- [x] 5.2 Confirm the `v5` floating tag is still pointing to the latest v5.x.x release (v5.0.1).
