...
- [x] 3.1 Update `openspec/specs/canonical-release-workflow/spec.md` with the modified version extraction requirement
- [x] 3.2 Archive this change once implementation is verified
