# raw-mode-preset-awareness Specification

## Purpose

Defines how read-only version inspection honors the selected preset and reports successful and failed resolution consistently.
