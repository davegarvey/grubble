# release-checksum-verification Specification

## Purpose

Defines how the GitHub Action verifies downloaded release artifacts before making the grubble binary available to a workflow.
